      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {benefits.map((benefit) => (
            <article
              key={benefit.id}
              className="group p-8 bg-cream rounded-2xl text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              {/* Icon */}
  ...
  return (
    ...
    >
      <path
        ...
        d="M12 2a2 2 0 100 4 2 2 0 000-4z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 8v4m0 0l-4 8m4-8l4 8M6 12h12"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M9.75 4.5c0 1.657-1.007 3-2.25 3S5.25 6.157 5.25 4.5 6.257 1.5 7.5 1.5s2.25 1.343 2.25 3z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 21c-4.97 0-9-4.03-9-9 0-4.97 8-12 9-12s9 7.03 9 12c0 4.97-4.03 9-9 9z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 21V11m0 0c-2 0-4-1-4-3m4 3c2 0 4-1 4-3"
      />
    </svg>
  );
}
